...
class Imagen extends Model
{
    ...
    {        
        return url().'/imagenes/'. $this->path . HelpersGenerales::helper_convertir_cadena_para_url($this->name) . '-'.$this->id . '-vertical.jpg';
    }

    public function getUrlImgVerticalChicaAttribute()
    {        
        return url().'/imagenes/'. $this->path . HelpersGenerales::helper_convertir_cadena_para_url($this->name) . '-'.$this->id . '-vertical-chica.jpg';
    }
