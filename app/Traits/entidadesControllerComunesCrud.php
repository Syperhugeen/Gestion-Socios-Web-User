...
trait entidadesControllerComunesCrud
{
    ...
    /**
     * Es el ancho para crear la imagen miniatura
     */
    ...
    /**
     * Son las dimenciones del recorte de la imagen se recorta de manera centrada
     */
    public function getImagenVerticalRecorte()
    {
        return ['width' => 600, 'height' => 1020];
    }
    ...
    public function set_admin_crear(Request $Request)
    {
        ...
        if ($files[0] != null) {
            ...
            foreach ($files as $file) {
                ...
                // I m a g e n   v e r t i c a l
                $this->ImagenRepo->setImagenEnStorage($file, $Imagen->path, $Nombre_de_la_imagen . '-vertical', '.jpg', null, $this->getImagenVerticalRecorte());
