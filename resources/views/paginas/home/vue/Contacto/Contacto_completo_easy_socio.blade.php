...
<p class="col-12 text-bold  mb-4"><i class="far fa-user"></i> Hablanos de vos</p>
...
<fieldset class="float-label mb-0">
  ...
  <input
                ...
                <div class="mb-2">
                  <small>*Obligatorio  @if( !Session::get('esDeUruguay'))  Agregar código internacional @endif</small>
                </div>
...
<div class="row mb-4 ">
<p class="col-12 text-bold  mb-4"><i class="far fa-building"></i> Tu negocio</p>
<div class="col-lg-6">
  <fieldset class="float-label mb-0">
  <input
                    name="Tu negocio"
    ...
    <div class="row mb-4 justify-content-end">
      ...
      <div class="row align-items-center  col-12 mb-2 " v-for="negocio in tipoDeNegocios">
        <input class="m-0 mr-2" type="radio" :id="negocio" :name="negocio" :value="negocio" v-model="data_mensaje.tipo_de_negocio">
    ...
    <div class="row mb-4 justify-content-end">
      ...
      <div class="row align-items-center  col-12 mb-2 " v-for="cantidad in cantidadDeClientes">
        <input class="m-0 mr-2" type="radio" :id="cantidad" :name="cantidad" :value="cantidad" v-model="data_mensaje.cantidad_de_clientes">
    ...
    <div class="row mb-4 justify-content-end">
      ...
      <div class="row align-items-center  col-12 mb-2 " v-for="funcion in funciones">
        <input class="m-0 mr-2" type="checkbox" :id="funcion.name" :name="negocio" :value="funcion.name" v-model="data_mensaje.funciones">
        <label class="color-text-gris m-0" :for="funcion.name">@{{funcion.name}}</label>
      </div>
...
<div class="row mb-4 ">
<p class="col-12 text-bold  mb-4">¿Cuál es el principal motivo por el cual buscas un software?</p>
<div class="col-lg-12 mb-5">
  <fieldset class="float-label ">

  <textarea name="Tu mensaje"
   id="" required cols="120" rows="60"  v-model="data_mensaje.mensaje"   class="input-text-class-primary"></textarea>
