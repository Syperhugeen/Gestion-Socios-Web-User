  ...
  <div class="container">
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-6" :class="ordenTextClass">
        ...
        <slot name="description-visible"> </slot>

        <transition v-if="showSection" name="slide-fade">
          <slot name="description-oculta"> </slot>
        </transition>

        <div
          v-if="con_parte_oculta"
        ...
        >
          ...
          <span v-else> Leer menos <i class="fas fa-chevron-up"></i> </span>
        </div>
      </div>
      <div
        :class="ordenImgClass"
        class="col-lg-6 p-2 p-lg-5 d-flex flex-row align-items-center justify-content-center"
      >
        <lazy-width-observer>
          ...
          <img
            v-else
            class="img-fluid helper-border-radius-16"
            :src="$root.mostrar_para_celuar ? url_img_chica : url_img_grande"
            :alt="titulo"
          />
        </lazy-width-observer>
      </div>
