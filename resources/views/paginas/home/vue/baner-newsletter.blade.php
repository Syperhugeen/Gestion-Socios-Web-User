...
<div  v-if="!yaSeRegistro" class=" col-12 d-flex flex-column  align-items-center shadow-sm py-4" style="background-color: #44e0d1;" >
  <div class="col-12 col-lg-7 h6 mb-3 text-white text-center">
      @{{titulo}}
  </div>
