   ...
   <section class="site-section py-5 ">
      ...
      <section-card
       ...
       url_img_chica="{{url()}}/imagenes/PaginasPersonalizadas/Socios/programa-para-administrar-socios-en-la-nube.jpg"
       url_img_grande="{{url()}}/imagenes/PaginasPersonalizadas/Socios/programa-para-administrar-socios-en-la-nube.jpg" >
   ...
   {{-- V e r s i ó n   a c t u a l i z a d a  --}}
    ...
    <section-card
      ...
      order="left"
      :con_parte_oculta="true"
      url_img_chica="{{url()}}/imagenes/Easysocio/Home/easysocio-es-simple-de-usar.png"
      url_img_grande="{{url()}}/imagenes/Easysocio/Home/easysocio-es-simple-de-usar.png" >

      <template slot="description-visible">
      <h3 class="mb-4">EasySocio es <span class="font-secondary helper-aumenta-texto"> easy </span> de usar </h3>
      ...
      <section-card
       ...
       order="right"
       :con_parte_oculta="false"
       url_img_chica="{{url()}}/imagenes/PaginasPersonalizadas/Socios/estado-de-cuenta-de-programa-de-administracion-de-socio.jpg"
       url_img_grande="{{url()}}/imagenes/PaginasPersonalizadas/Socios/estado-de-cuenta-de-programa-de-administracion-de-socio.jpg" >
      ...
      <section-card
       ...
       order="right"
       :con_parte_oculta="false"
       url_img_chica="{{url()}}/imagenes/PaginasPersonalizadas/Socios/programa-para-gestionar-socios-entrenamiento-a-clientes.jpg"
       url_img_grande="{{url()}}/imagenes/PaginasPersonalizadas/Socios/programa-para-gestionar-socios-entrenamiento-a-clientes.jpg" >
