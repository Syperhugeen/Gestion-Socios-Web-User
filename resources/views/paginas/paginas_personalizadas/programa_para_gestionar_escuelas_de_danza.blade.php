...
@section('contenido')
        ...
        grandiente="linear-gradient(180deg, rgba(63,94,251,1) 0%, rgba(252,70,107,1) 100%)"
        >
            ...
            <template slot="descripcion">
               ...
               <img class="d-none d-lg-block " style="position: absolute; right:0; top:5%; height:auto; width:600px;"  src="{{url()}}/imagenes/Easysocio/Paquetes/academias-de-baile-png.png" alt="">
