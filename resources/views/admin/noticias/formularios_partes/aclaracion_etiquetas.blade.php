<div class="p-5 col-12 color-text-gris background-gris-0 mb-4">
  ...
  <div class="lista-class aclaracion-de-etiquetas-linea"> Imagen: <span class="text-bold"> (IMG) Aquí url de la imagen  (/IMG) </span> </div>
    ...
    <div class="lista-class aclaracion-de-etiquetas-linea"> Títulos linea de tiempo: <span class="text-bold"> (TLT) (/TLT)</span> </div>

    <div class="lista-class aclaracion-de-etiquetas-linea"> Código: <span class="text-bold"> (CODE) (/CODE)</span> </div>

    <div class="lista-class aclaracion-de-etiquetas-linea"> Lenguaje del código: <span class="text-bold"> (LENGUAJE) (/LENGUAJE)</span> </div>
